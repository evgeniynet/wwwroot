...
$pageTitle='<span  class="reg">The Best B2B customer support system on the web</span>';
...
<html lang="en">
    <head>
        ...
        if (get_field("sherpa-landing-title")==""){
        ?>
        <!-- this is where experiment and optimizely code goes -->
        <?php
        }
        ?>
        <script>
        ...
        <div id="HomePanel">
            <header>
                <div class="navigation">
                    ...
                    <a href="/start-your-climb">
                        <span class="navigationItem"><p>Sign Up</p></span>
                    </a>
                    <a href="http://app.sherpadesk.com">
                ...
                <div id="titleContainer" class="titleWrapper" itemscope itemtype="http://schema.org/product">
                    ...
                    <div class="subTitleWrapper">
                        <ul>
                            ...
                            <a href="#invoiceSS">
                                <li id="featureThree" itemprop="description">Easy Invoicing</li>
                            </a>
                        </ul>
                    </div>
