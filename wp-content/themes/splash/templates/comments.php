<?php
 ...
 if (have_comments()) : ?>
  <section id="comments">
    <h3 class="comments-headline"><?php printf(_n('One Response to &ldquo;%2$s&rdquo;', '%1$s Responses to &ldquo;%2$s&rdquo;', get_comments_number(), 'roots'), number_format_i18n(get_comments_number()), get_the_title()); ?></h3>
