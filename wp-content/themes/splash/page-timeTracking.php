 ...
 */
  ...
  if(get_field("sherpa-landing-title")==""):
    $pageTitle='<span  class="smallStay">"The </span><span class="huge">Best <span id="damn">Damn</span></span><span class="reg"> IT Support System</span><span class="small"> on the</span><span class="big"> Web!"</span>';
...
<script>
  ...
  ga('send', 'pageview');
    ...
    <?php wp_head(); ?>
    <title>IT Support & Time Tracking| Sherpadesk</title>
    <meta charset="UTF-8">
...
<div id="HomePanel">
 ...
 <ul class="headerNav">
    ...
    <div id="titleContainer" class="titleWrapper" itemscope itemtype="http://schema.org/product">
        <h1 itemprop="description"><h1>Support ticket tracking and time managment</h1></h1>
    ...
    <a href="/start-your-climb">
        <div  id="headerGetStarted"class="getStartedButton">Get Started </div> </a>
    <!-- <a href="/start-your-climb">
    ...
    <section itemtype="http://schema.org/product" class="screenShot">
        <ul>
            ...
            <li class="medDisplay SSText mobileOnly">
                <h2>Activity Dates & Time Stamping</h2>
    ...
    <section  itemtype="http://schema.org/product" class="mobile">
        <h1>Keep up with your team <span>24/7</span></h1>
