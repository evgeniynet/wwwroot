                ...
                <div class="container">
                    ...
                    <div class="col-lg-7 col-md-6 col-sm-12">
                        ...
                        <div class="call-to-action">
                            ...
                            <a class="btn btn-lg btn-success pull-right" href="/start-your-climb">Get A Free Account Now!</a>&nbsp;&nbsp;&nbsp;&nbsp;
...
<li><img src="<?php echo get_template_directory_uri(); ?>/images/logo5.png" /></li>
            ...
            <div class="container-fluid integration-logos">
                ...
                <div class="container" style="text-align: center;">
                    ...
                    <img class="img-responsive" style="margin: 0 auto;" src="<?php echo get_template_directory_uri(); ?>/images/integrations.png" alt="client management software">
            ...
            <div class="pricing-plan-container">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <h1 style="color: white;">SherpaDesk Grows with Your Business</h1>
                        <p style="text-align: center;">We understand sometimes you just need something to get you started. That’s why every <br/>

                            SherpaDesk account includes your first user FREE. You can add users easily for just <br/>

                            $39 per month as your company grows.</p>
                        <div class="pricing-plan">
                            ...
                            <strong>First User Free</strong></br>
    ...
    <div class="container plan-includes">
        ...
        <div class="row">
            ...
            <div class="col-xs-12">
                ...
                <h2>With SherpaDesk you get...</h2></br>
