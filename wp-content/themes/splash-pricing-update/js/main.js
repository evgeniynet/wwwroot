...
//			$('.titleWrapper').css('margin-top',scrolltop / 2);
//
//
//
//
...
//				//$(".navigation").css("box-shadow","0px 5px 5px rgba(136, 136, 136, 0.26)");
//				$('#headerButton').show();
//				//$('#mobileNavigation').css('color','#4c5156');
//   			}else{
//   				//$('#logo').show();
//   				//$('#logoBlue').hide();
//   				//$(".navigation").css("background-color","transparent");
//   				//$("header p").css("color","#fff");
//   				//$(".navigation").css("box-shadow","0px 5px 5px rgba(136, 136, 136, 0)");
//   				$('#headerButton').hide();
//   				//$('#mobileNavigation').css('color','#fff');
//   			}
//	 	});
//	},
//};
...
var priceCalc = {
	...
	var addPhoneNumber = {
		...
		addNumber:function(){
			...
			$('#contactUs').click(function(){
				if(clicked < 1){
				setTimeout(function(){
					var insert = "<p class='callUs'><span>Support </span>1 866 996 1200</p>";
	...
	var AbTesting = {
		...
		cleanUrl:function() {
		//window.history.replaceState( 'IT Support Software & Customer Support Software', 'IT Support Software & Customer Support Software', 'http://sherpadesk.com');
		}
	};
