...
$scope.message('warning', 'FYI. Company name is already exists in system. Click submit again to proceed with given name');
...
$scope.message('warning', 'Email "'+$scope.signUp.email+'" is already in our system. Click submit again to proceed to register new org OR <a style="color:black" href="https://app.sherpadesk.com/login/">click HERE</a> to login as normal');
$scope.signUp.force = true;
return false
}
if(data.isUrlExists){
