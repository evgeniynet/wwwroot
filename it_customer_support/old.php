...
<div class="row">
<div class="col-sm-6">
<div class="form-section" style="z-index: 2;">
<div class="form-header" style="margin: -10px -10px 0;padding: 10px;background: #004174;color: #fff !important;">
<p style="color: #fff !important;">Track Time. Automate Invoices. <br/>Make Smarter Decisions.</p>
<h3 style="color: #fff !important;">Start Free Trial Now!</h3>
</div></div>
<iframe  scrolling="no" src="https://app.sherpadesk.com/mc/signuporg.aspx" style="width: 100%;height: 1145px;border: none;margin-top: -100px;margin-left: 15px;"></iframe-->
<div ng-app="app">
